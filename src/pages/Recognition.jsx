    ...
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  ">
      ...
      <div className="w-full grid grid-cols-4">
        ...
        <canvas
         ...
         />
      <div className=''>
      <div className="grid grid-cols-3 gap-2 bg-slate-100 p-2 rounded-md mt-1">
            <img className="shadow-sm rounded-sm" src='avatar.jpg'/>
            <div className="col-span-2">
                <span className='inline-flex gap-1'><BiUser className='text-gray-500'/><b className='text-[13px]'>Nguyễn Viết Nam</b></span>
                <span className='inline-flex gap-1'><BiCalendar className='text-gray-500'/><p className='text-xs text-gray-600'>13:00:21 01/12/2022</p></span>
            </div>
        </div>
        <div className="grid grid-cols-3 gap-2 bg-slate-100 p-2 rounded-md mt-1">
            <img className="shadow-sm rounded-sm" src='avatar.jpg'/>
